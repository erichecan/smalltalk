  ...
  return (
    <Container sx={{ minHeight: '100vh', bgcolor: '#f8fcf8', p: 0, fontFamily: 'Spline Sans, Noto Sans, sans-serif' }}>
      ...
      <Box sx={{ position: 'sticky', top: 0, zIndex: 10, bgcolor: 'rgba(248,252,248,0.8)', backdropFilter: 'blur(8px)', px: 2, py: 1.5, display: 'flex', alignItems: 'center', borderBottom: 0 }}>
        ...
        <Typography variant="h6" sx={{ flex: 1, textAlign: 'center', color: '#0d1b0d', fontWeight: 'bold', pr: 5 }}>Friend Profile</Typography>
      </Box>
      {/* 头像与基本信息 */}
      ...
      {/* 学习进度 */}
      <Box sx={{ mb: 4, px: 2 }}>
        <Typography variant="subtitle1" sx={{ color: '#0d1b0d', fontWeight: 600, mb: 2 }}>Learning Progress</Typography>
      ...
      {/* 兴趣标签 */}
      <Box sx={{ mb: 4, px: 2 }}>
        <Typography variant="subtitle1" sx={{ color: '#0d1b0d', fontWeight: 600, mb: 2 }}>Shared Interests</Typography>
        <Stack direction="row" spacing={1} flexWrap="wrap">
          <Chip label="Travel" sx={{ bgcolor: '#e7f3e7', color: '#0d1b0d', fontWeight: 500, fontSize: 16, mb: 1 }} />
          <Chip label="Food" sx={{ bgcolor: '#e7f3e7', color: '#0d1b0d', fontWeight: 500, fontSize: 16, mb: 1 }} />
          <Chip label="Culture" sx={{ bgcolor: '#e7f3e7', color: '#0d1b0d', fontWeight: 500, fontSize: 16, mb: 1 }} />
        </Stack>
      </Box>
      {/* 底部按钮 */}
