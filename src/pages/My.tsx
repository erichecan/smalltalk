import { Container, Box, Typography, Avatar, Paper, LinearProgress, Chip, Stack, Button, Menu, MenuItem, IconButton } from '@mui/material';
  ...
  return (
    <Container sx={{ minHeight: '100vh', bgcolor: '#f8fcf8', p: 0, fontFamily: 'Spline Sans, Noto Sans, sans-serif' }}>
      ...
      <Box sx={{ position: 'sticky', top: 0, zIndex: 10, bgcolor: 'rgba(248,252,248,0.8)', backdropFilter: 'blur(8px)', px: 2, py: 1.5, display: 'flex', alignItems: 'center', borderBottom: 0 }}>
        <IconButton onClick={handleMenuClick} sx={{ p: 1, borderRadius: '50%', color: '#0d1b0d', '&:hover': { bgcolor: '#e7f3e7' } }}>
          <MenuIcon />
        </IconButton>
        ...
        >
          ...
          <MenuItem onClick={handleReportProblem}>
