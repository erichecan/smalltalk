-- Quiz与Matching游戏化学习功能数据库升级脚本（简化版本）
-- 创建时间：2025-01-30 09:45:00
-- 简化版本，避免复杂的约束检查，确保稳定执行
...
-- 删除可能存在的旧策略（使用异常处理避免错误）
DO $$
BEGIN
    -- user_learning_profiles策略
    BEGIN
