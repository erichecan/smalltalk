-- SmallTalk 社交功能数据库架构 (安全版)
-- 创建时间: 2025-01-31 11:00:00
-- 修复内容: 解决列不存在错误，确保执行顺序正确
...
CREATE TABLE IF NOT EXISTS user_points (
  ...
  user_level INTEGER DEFAULT 1, -- 用户等级
...
BEGIN
  RAISE NOTICE '=================================================';
  RAISE NOTICE 'SmallTalk 社交功能数据库架构创建完成！(安全版)';
  RAISE NOTICE '包含功能:';
