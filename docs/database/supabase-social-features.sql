-- SmallTalk 社交功能数据库架构 (Supabase最终版)
-- 创建时间: 2025-01-31 11:15:00
-- 用途: 在Supabase中安全执行的最终版本
-- 特点: 完全兼容Supabase，无列引用错误
...
BEGIN
  RAISE NOTICE '=================================================';
  RAISE NOTICE 'SmallTalk 社交功能数据库架构创建完成！(Supabase最终版)';
  RAISE NOTICE '包含功能:';
